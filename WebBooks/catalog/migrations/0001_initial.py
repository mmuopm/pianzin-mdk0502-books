    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, help_text='Выберите фото автора', null=True, upload_to='images', verbose_name='Фото автора')),
            ],
        ),
        migrations.CreateModel(
            name='Genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.CharField(help_text='Выберите год издания книги', max_length=4, verbose_name='Год издания книги')),
                ...
                ('photo', models.ImageField(help_text='Выберите изображение книги', upload_to='images', verbose_name='Изображение книги')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inv_nom', models.CharField(help_text='Изменить инвентарный номер экземпляра', max_length=20, null=True, verbose_name='Инвентарный номер экземпляра')),
